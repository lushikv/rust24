    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <AdminLink className="rounded-md border border-white/10 px-4 py-3 text-sm font-black text-white" href="/admin/faq/categories">Categories</AdminLink>
          <AdminLink className="rounded-md bg-orange-500 px-4 py-3 text-sm font-black text-black" href="/admin/faq/articles/new">New article</AdminLink>
        </div>
      </div>
      ...
      <AdminDataTable
        columns={[
          ...
          { key: "edit", header: "Edit", render: (row) => <AdminLink className="font-bold text-orange-300" href={`/admin/faq/articles/${row.id}/edit`}>Edit</AdminLink> },
